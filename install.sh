...
usage() {
    ...
    echo "  gtm-foundations    (12 skills) — Market research, ICP, positioning, personas"
    echo "  outbound-engine    (12 skills) — Cold email, LinkedIn, calls, sequences"
    echo "  content-machine    (10 skills) — LinkedIn posts, blogs, newsletters, repurposing"
    echo "  abm-playbook       (10 skills) — Account mapping, executive outreach, ABM"
    echo "  sales-enablement   (10 skills) — Battlecards, proposals, discovery, coaching"
    echo "  revops-infra       (12 skills) — Email infra, CRM, enrichment, forecasting"
    echo "  freelancer-agency   (8 skills) — Scoping, onboarding, reporting, positioning"
    echo ""
    echo "Other commands:"
